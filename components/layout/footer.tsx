          ...
          <div>
            ...
            <div className="flex gap-3 mt-5">
              <a
                ...
                aria-label="Facebook"
                className="w-9 h-9 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:bg-[#E50000]/15 hover:border-[#E50000]/40 hover:text-white transition-colors"
              >
