  ...
  return (
    <section className="pt-32 pb-20 bg-black min-h-screen">
      <div className="max-w-6xl mx-auto px-6">
        <h1 className="font-heading text-5xl md:text-6xl mb-12"><span className="text-[#E50000]">CONTACTEZ</span>-NOUS</h1>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className="space-y-8">
            <div>
              ...
              <ul className="space-y-4 text-gray-400">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <a href={`tel:${COMPANY.phone.replace(/\s/g, "")}`} className="text-white hover:text-[#E50000] transition-colors text-lg font-semibold">{COMPANY.phone}</a>
                ...
                <li className="flex items-start gap-3">
                  <span className="text-[#E50000] text-xl">📱</span>
                  <div>
                    <a href={`tel:${COMPANY.mobile.replace(/\s/g, "")}`} className="text-white hover:text-[#E50000] transition-colors text-lg font-semibold">{COMPANY.mobile}</a>
                    <p className="text-sm">Mobile</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-[#E50000] text-xl">✉️</span>
                  <a href={`mailto:${COMPANY.email}`} className="text-white hover:text-[#E50000] transition-colors">{COMPANY.email}</a>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-[#E50000] text-xl">📍</span>
            ...
            <LinkButton href="/devis" size="lg" className="bg-[#E50000] hover:bg-[#B80000] text-white w-full py-6">
